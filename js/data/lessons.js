...
export const LESSONS = [
  ...
  },
  {
    ...
    task: {
      ...
      options: [
        { en: 'go', pl: 'iść (teraz, teraźniejszość)' },
        { en: 'went', pl: 'poszedłem / poszłam (przeszłość)' },
        { en: 'gone', pl: '(już) poszedł — 3. forma' },
      ],
      hintSpoken: 'To było wczoraj — czyli przeszłość. Kojarz to z czymś, co już się wydarzyło. To druga forma czasownika „go".',
